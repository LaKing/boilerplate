...
es6_debuglog_Ł += "       }\n";
es6_debuglog_Ł += "   console.log('┗━━━━', '@' + from, '"+ ß.EDITOR_LINKBASE +"' + ß.VUE_LINK_SOURCE_TREE[from] + from);\n";
...
es6_debuglog_ŁOG += "   }\n";
es6_debuglog_ŁOG += "   console.log('┗━━━━', '@' + from, '"+ ß.EDITOR_LINKBASE +"' + ß.VUE_LINK_SOURCE_TREE[from] + from);\n";
